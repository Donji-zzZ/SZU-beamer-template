...
\title{SZU Beamer Presentation Theme}
\subtitle{Using \LaTeX\ to prepare slides}
% \course{Master's Degree in Computer Science}
\author{\href{mailto:jidon0012@gmail.com}{Chenyu Zhou}}
% \IDnumber{1234567}
\date{2024/04}
...
SZU style adaptation contributed by \hrefcol{https://github.com/Donji-zzZ/SZU-beamer-template}{Chenyu Zhou}
...
\begin{chapter}[assets/background-szu-negative]{}{Special Slides}
\begin{itemize}
\item Chapter slides
...
\begin{sidepic}{assets/szu_view}{Side-Picture Slides}
\begin{itemize}
...
\hrefcol{mailto:jidon0112@gmail.com}{send them to me!}
\end{itemize}
\end{frame}
